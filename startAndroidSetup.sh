...
sudo unzip android-sdk.zip -d  /usr/local/lib/android/
rm -f android-sdk.zip

sudo touch /root/.android/repositories.cfg 
echo y | sudo sdkmanager "platforms;android-$SDK_BUILD_VERSION" >/dev/null
echo y | sudo sdkmanager "platform-tools" >/dev/null
echo y | sudo sdkmanager "build-tools;$SDK_BUILD_TOOLS_VERSION" >/dev/null
